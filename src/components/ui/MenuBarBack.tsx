...
import { BriefcaseBusiness, House, Send } from 'lucide-react'
    ...
    >
      <div className="flex justify-around w-7/8 border border-light/30 rounded-full py-3 bg-dark/70 backdrop-blur-sm text-[.7rem] font-bold font-inter tracking-widest md:w-90" >
        ...
        <Link to="/" className='flex items-center group'>
          <House className="transition-colors duration-300 group-hover:text-teal-400 group-hover:drop-shadow-[0_0_6px_#14b8a6]" />
          <span className="max-w-0 overflow-hidden opacity-0 transition-all duration-300 group-hover:max-w-xs group-hover:opacity-100 group-hover:ml-2 group-hover:text-teal-400 group-hover:drop-shadow-[0_0_6px_#14b8a6]">{t("menu.1")}</span>
        </Link>
        <Link to="/#work" className='flex items-center gap-2 group'>
