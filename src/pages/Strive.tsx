            ...
            <div className="px-5 lg:px-16 max-w-[1820px] mx-auto">
                ...
                <section className=" flex flex-col lg:flex-row items-center ">
                    ...
                    <div className="lg:pl-30 font-courier leading-[2.3rem] text-justify mt-24">
                        ...
                        <Trans i18nKey="strive.research2">
                        <p >Para complementar esta fase, realicé entrevistas informales con entusiastas del tuning y skaters, lo que me ayudó a comprender qué valores emocionales conectaban más con ellos:
